...
public class BenchmarkHanoi2 {
	public static final int STEP_SIZE = 199290;
	...
	public static class SharedData{
		...
		public void setup() throws FileNotFoundException{
			vectors = Test.readVectors(getClass().getResourceAsStream("/hanoi.2.txt"));
    ...
    public static void main(String[] args) throws RunnerException{
        ...
        .include(".*" + BenchmarkHanoi2.class.getSimpleName() + ".*")
        .warmupIterations(5)
