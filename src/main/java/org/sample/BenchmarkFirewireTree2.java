...
public class BenchmarkFirewireTree2 {
	public static final int STEP_SIZE = 700;
	public static final String FILE_PATH = "/vectors_firewire_tree_2.txt";
	...
	public static class SharedData{
		...
		public void setup() throws FileNotFoundException{
			vectors = Test.readVectors(getClass().getResourceAsStream(FILE_PATH));
    ...
    public static void main(String[] args) throws RunnerException{
        ...
        .include(".*" + BenchmarkFirewireTree2.class.getSimpleName() + ".*")
        .warmupIterations(5)
